...
#    cam_height=600
    ...
    cam_height=240
    cam_frames=30
    return 'v4l2src device=/dev/video'+str(n)+' io-mode=4 ! image/jpeg,width='+str(cam_width)+',height='+str(cam_height)+',framerate='+str(cam_frames)+'/1 ! mppvideodec ! videoconvert ! video/x-raw ! appsink'
...
def get_camerasrc_nv12(n):
    ...
    cam_height=480
    cam_frames=30
    return 'v4l2src device=/dev/video'+str(n)+' io-mode=4 ! videoconvert ! video/x-raw,format=NV12,width='+str(cam_width)+',height='+str(cam_height)+',framerate='+str(cam_frames)+'/1 ! videoconvert ! appsink'
